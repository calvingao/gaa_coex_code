                ...
                for loc in locs:
                    ...
                    for den in dens:
                        ...
                        for et in ets:
                            ...
                            bwcdf_legend.append("Density=" + str(den) + ", ET="+str(app3_bw.get("et")))
                            ...
                            ixiccdf_legend.append("Density=" + str(den) + ", ET="+str(app3_bw.get("et")))
                            ixiccdf_style.append((lines[ls], color))

                    bwrow.append((bwcdf_data, bwcdf_legend, bwcdf_style, loc_txt + ", " + pm_txt))
                    ixrow.append((ixiccdf_data, ixiccdf_legend, ixiccdf_style, loc_txt + ", " + pm_txt))
